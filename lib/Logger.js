...
class Logger {
    ...
    _baseLog(logName, message, saveInDb){
        const placeholdersData = generateDataForPlaceholder({message: JSON.stringify(message, null, "\t"), id: this.id, logName: logName, name: this.#config.name}, this.#config.DateFormater)
